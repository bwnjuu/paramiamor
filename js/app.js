...
no.addEventListener("click", () => {
  if (count == 2) {
    gif.src = "../resources/zorro.gif";// gif credit: https://knowyourmeme.com/photos/2738959-mr-fresh-side-eye-cat
    ...
    gif.src = "../resources/confused.gif";// gif credit: https://tenor.com/view/tkthao219-peach-goma-gif-25008901
